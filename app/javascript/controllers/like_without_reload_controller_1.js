    ...
    if (this.i % 2 == 1) {
      fetch(this.likeButtonTarget.parentNode.action.slice(0, -4).concat("like"),
        ...
        .then(
          (response) => {
            if (response.ok) {
              this.likeButtonTarget.getElementsByClassName("fa-heart")[0].classList.add("fa-solid"),
              this.likeButtonTarget.getElementsByClassName("fa-heart")[0].classList.remove("fa-regular"),
              this.likeButtonTarget.getElementsByClassName("fa-heart")[0].classList.add("liked-heart"),
      ...
      fetch(this.likeButtonTarget.parentNode.action.slice(0, -4).concat("unlike"),
        ...
        .then(
          (response) => {
            if (response.ok) {
              this.likeButtonTarget.getElementsByClassName("fa-heart")[0].classList.remove("fa-solid"),
              this.likeButtonTarget.getElementsByClassName("fa-heart")[0].classList.add("fa-regular"),
              this.likeButtonTarget.getElementsByClassName("fa-heart")[0].classList.remove("liked-heart"),
              this.likes = this.likes - 1,
              this.i += 1,
              this.likesNumberTarget.innerText = `${this.likes} ${this.likes == 1 ? 'like' : 'likes'}`
            }
